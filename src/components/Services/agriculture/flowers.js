...
const flowerProjects = [
  {
    id: 1,
    name: "pannala_flowers",
    project: "flowerProject",
    district: "kurunegala",
    office: "pannala",
    product: "flowers",
    amount: "3 690 000,00",
    location: "pannala_cluster",
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-10 space-y-10">
        ...
        <table className="min-w-full border border-gray-300">
          ...
          <tbody>
            {flowerProjects.map((item) => (
              <tr
                key={item.id}
                className="hover:bg-[#FEC5F6] cursor-pointer transition-colors"
      ...
      <div ref={scrollTargetRef} className="w-full flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="w-full lg:w-1/2 h-[350px] bg-[#FCE4F8] p-6 rounded-md shadow-md overflow-y-auto">
          <h2 className="text-xl font-bold text-[#C562AF] mb-4">
